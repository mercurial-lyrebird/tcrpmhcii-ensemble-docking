...
def rechain_amber_frames(model: Complex, reference: pMHCII) -> pMHCII:

    mhc_a_seq = str(reference.mhc.alpha_chain.sequence)
...
if __name__ == "__main__":
    ...
    template_pdb_fp = os.path.join(
        "../../data/mhcii_templates/", f"{pdb_id}.pdb"
    )
    amber_dir = sys.argv[2]
    dest_dir = sys.argv[3]
